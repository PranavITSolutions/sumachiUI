...
function get_custom_project_meta_fields() {
	...
	$tabs_array['cmsmasters_project'] = array( 
		'label' => esc_html__('Project', 'all-business'), 
		'value'	=> 'cmsmasters_project' 
	);
	
	
	$tabs_array['cmsmasters_layout'] = array( 
		'label' => esc_html__('Layout', 'all-business'), 
	...
	$tabs_array['cmsmasters_heading'] = array( 
		'label' => esc_html__('Heading', 'all-business'), 
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Project Images', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Number of Columns', 'all-business'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'three' => array( 
					'label' => esc_html__('Three', 'all-business'), 
					'value'	=> 'three' 
				), 
				'two' => array( 
					'label' => esc_html__('Two', 'all-business'), 
					'value'	=> 'two' 
				), 
				'one' => array( 
					'label' => esc_html__('One', 'all-business'), 
					'value'	=> 'one' 
				) 
			) 
		),
		...
		array( 
			'label'	=> esc_html__('Video Type', 'all-business'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'embedded' => array( 
					'label' => esc_html__('Embedded (YouTube, Vimeo)', 'all-business'), 
					'value'	=> 'embedded' 
				), 
				'selfhosted' => array( 
					'label' => esc_html__('Self-Hosted', 'all-business'), 
					'value'	=> 'selfhosted' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Embedded Video Link', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Self-Hosted Video Links', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Color', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Title', 'all-business'), 
		...
		array( 
			'label'	=> esc_html__("'Read More' Buttons Text", 'all-business'), 
			'desc'	=> esc_html__("Enter the 'Read More' button text that should be used in you blog shortcode", 'all-business'), 
			'id'	=> $cmsmasters_option_name . 'read_more', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('Read More', 'all-business') 
		), 
		array( 
			'label'	=> esc_html__('Project Size', 'all-business'), 
			'desc'	=> esc_html__('Recommended Featured Image dimensions, or other size, with the same ratio', 'all-business') . ' - ', 
		...
		array( 
			'label'	=> esc_html__('Project Details Title', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Info', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__("Project Link Text", 'all-business'), 
			'desc'	=> '', 
			'id'	=> $cmsmasters_option_name . 'link_text', 
			'type'	=> 'text', 
			'hide'	=> '', 
			'std'	=> esc_html__('View Project', 'all-business') 
		), 
		array( 
			'label'	=> esc_html__("Project Link URL", 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> '', 
			'desc'	=> esc_html__('Redirect to project link URL instead of opening project page', 'all-business'), 
		...
		array( 
			'label'	=> esc_html__("Project Link Target", 'all-business'), 
			'desc'	=> esc_html__('Open link in a new tab', 'all-business'), 
		...
		array( 
			'label'	=> esc_html__('Project Features 1 Title', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 1', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2 Title', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 2', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3 Title', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Project Features 3', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Sharing Box', 'all-business'), 
			'desc'	=> esc_html__('Show', 'all-business'), 
		...
		array( 
			'label'	=> esc_html__('About Author Box', 'all-business'), 
			'desc'	=> esc_html__('Show', 'all-business'), 
		...
		array( 
			'label'	=> esc_html__('More Posts Box', 'all-business'), 
			'desc'	=> '', 
			...
			'options' => array( 
				'related' => array( 
					'label' => esc_html__('Show Related Tab', 'all-business'), 
					'value'	=> 'related' 
				), 
				'popular' => array( 
					'label' => esc_html__('Show Popular Tab', 'all-business'), 
					'value'	=> 'popular' 
				), 
				'recent' => array( 
					'label' => esc_html__('Show Recent Tab', 'all-business'), 
					'value'	=> 'recent' 
				), 
				'hide' => array( 
					'label' => esc_html__('Hide More Posts Box', 'all-business'), 
					'value'	=> 'hide' 
				) 
			) 
		), 
		...
		array( 
			'label'	=> esc_html__('Page Color Scheme', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Bottom Sidebar', 'all-business'), 
			'desc'	=> esc_html__('Show', 'all-business'), 
		...
		array( 
			'label'	=> esc_html__('Choose Bottom Sidebar', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Choose Bottom Sidebar Layout', 'all-business'), 
			'desc'	=> '', 
