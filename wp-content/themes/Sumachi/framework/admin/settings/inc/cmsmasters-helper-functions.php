...
function all_business_get_admin_page() {
	global $pagenow;
...
function all_business_default_tab() {
	$current_page = all_business_get_admin_page();
...
function all_business_get_the_tab() {
	global $pagenow;
	
	$default_tab = all_business_default_tab();
...
function all_business_settings_page_header() {
