...
add_action('admin_menu', 'all_business_add_menu');
add_action('admin_init', 'all_business_register_settings');
...
function all_business_get_settings() {
	$output = array();
	
	
	$page = all_business_get_admin_page();
	...
	case CMSMASTERS_PAGE_BASENAME:
		...
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'all-business');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_general_sections_filter', all_business_options_general_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_general_fields_filter', all_business_options_general_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_general_tabs_filter', all_business_options_general_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-font':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'all-business');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_font_sections_filter', all_business_options_font_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_font_fields_filter', all_business_options_font_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_font_tabs_filter', all_business_options_font_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-color':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'all-business');
		$cmsmasters_page_sections = all_business_options_color_sections();
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_color_fields_filter', all_business_options_color_fields(), $tab);
		$cmsmasters_page_tabs = all_business_options_color_tabs();
	...
	case CMSMASTERS_PAGE_BASENAME . '-element':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'all-business');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_element_sections_filter', all_business_options_element_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_element_fields_filter', all_business_options_element_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_element_tabs_filter', all_business_options_element_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-single':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'all-business');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_single_sections_filter', all_business_options_single_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_single_fields_filter', all_business_options_single_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_single_tabs_filter', all_business_options_single_tabs());
	...
	case CMSMASTERS_PAGE_BASENAME . '-demo':
		...
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'all-business');
		$cmsmasters_page_sections = all_business_options_demo_sections();
		$cmsmasters_page_fields = all_business_options_demo_fields();
		$cmsmasters_page_tabs = all_business_options_demo_tabs();
...
function all_business_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'all-business'), 
		'desc' => 		esc_html__('This is a default description.', 'all-business'), 
		'std' => 		'', 
		'type' => 		'text', 
...
function all_business_register_settings() {
	$settings_output = all_business_get_settings();
	...
	register_setting($cmsmasters_option_name, $cmsmasters_option_name, 'all_business_validate_options');
	
	
	if (!empty($settings_output['cmsmasters_page_sections'])) {
		foreach ($settings_output['cmsmasters_page_sections'] as $id => $title) {
			add_settings_section($id, $title, 'all_business_section_fn', __FILE__);
		}
	}
	...
	if (!empty($settings_output['cmsmasters_page_fields'])) {
		foreach ($settings_output['cmsmasters_page_fields'] as $option) {
			all_business_create_settings_field($option);
		}
	}
	
	
	if (($current_page === 'cmsmasters-settings-color' || $current_page === 'cmsmasters-settings-font') && $page_updated) {
		all_business_regenerate_styles();
	}
}


function all_business_settings_scripts() {
	...
	wp_localize_script('cmsmasters_theme_settings_js', 'cmsmasters_setting', array( 
		...
		'remove_sidebar' => 	esc_html__('Do you realy want to remove this sidebar?', 'all-business'), 
		'find' => 				esc_attr__('Find icons', 'all-business'), 
		'remove_icon' => 		esc_html__('Do you realy want to remove this social icon?', 'all-business'), 
		'theme_uri' => 			get_template_directory_uri(), 
		'shortname' => 			CMSMASTERS_SHORTNAME, 
		'done' => 				esc_html__('All theme settings were imported successfully.', 'all-business'), 
		'fail' => 				esc_html__("Error on page!!!\nPlease reload page and try again.", 'all-business'), 
...
function all_business_add_menu() {
	$settings_output = all_business_get_settings();
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'all-business'), 
		esc_attr__('Theme Settings', 'all-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME, 
		'all_business_settings_page_fn', 
		'' 
	);
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme General Settings', 'all-business'), 
		esc_attr__('General', 'all-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME, 
		'all_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_general, 'all_business_settings_scripts');
	
	
	$cmsmasters_settings_font = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Fonts Settings', 'all-business'), 
		esc_attr__('Fonts', 'all-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-font', 
		'all_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_font, 'all_business_settings_scripts');
	
	
	$cmsmasters_settings_color = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Color Schemes', 'all-business'), 
		esc_attr__('Colors', 'all-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-color', 
		'all_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_color, 'all_business_settings_scripts');
	
	
	$cmsmasters_settings_element = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Elements Settings', 'all-business'), 
		esc_attr__('Elements', 'all-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-element', 
		'all_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_element, 'all_business_settings_scripts');
	
	
	$cmsmasters_settings_single = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Single Posts Settings', 'all-business'), 
		esc_attr__('Single Posts', 'all-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-single', 
		'all_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_single, 'all_business_settings_scripts');
	
	
	$cmsmasters_settings_demo = $add_submenu_p( 
		CMSMASTERS_PAGE_BASENAME, 
		esc_attr__('Theme Settings Import/Export', 'all-business'), 
		esc_attr__('Import/Export', 'all-business'), 
		'manage_options', 
		CMSMASTERS_PAGE_BASENAME . '-demo', 
		'all_business_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_demo, 'all_business_settings_scripts');
}


function all_business_section_fn($desc) {
	$tab = all_business_get_the_tab();
...
function all_business_settings_page_fn() {
	$settings_output = all_business_get_settings();
	$current_tab = all_business_get_the_tab();
	
	echo '<div class="wrap">';
	
	all_business_settings_page_header();
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'all-business') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'all-business') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'all-business') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function all_business_form_field_fn($args = array()) {
	extract($args);
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'all-business') . '" data-title="' . esc_attr__('Choose Image', 'all-business') . '" data-button="' . esc_attr__('Insert Image', 'all-business') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" alt="" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'all-business') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (all_business_system_fonts_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_system_font'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'all-business') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'all-business') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'all-business') . ' <em>(' . esc_html__('in pixels', 'all-business') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'all-business') . ' <em>(' . esc_html__('in pixels', 'all-business') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'all-business') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'all-business') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (all_business_text_transform_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_transform'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'all-business') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (all_business_text_decoration_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_decoration'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'all-business') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'all-business') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'all-business') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'all-business') . '"></a>' . 
			'</p>' . 
			'<span class="cl"><br /></span>' . 
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_color">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Color', 'all-business') . '</span>' . 
				...
				'<label for="new_icon_hover">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Hover Color', 'all-business') . '<br /><em>' . esc_html__('if not selected - Icon Color will be used', 'all-business') . '</em></span>' . 
				...
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'all-business') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'all-business') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'all-business') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'all-business') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'all-business') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'all-business') . '"></a> ' . 
...
function all_business_validate_options($input) {
	$valid_input = array();
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'all-business');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						CMSMASTERS_SHORTNAME . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'all-business'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'all-business');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						...
						esc_html__('Expecting comma separated numeric values! Please fix.','all-business'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'all-business');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'all-business');
				}
				...
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						...
						esc_html__('Please enter a valid email address.', 'all-business'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'all-business');
...
function theme_admin_bar_render() {
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Theme Settings', 'all-business'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('General', 'all-business'), 
		'href' => esc_url(admin_url('admin.php?page=cmsmasters-settings')) 
	));
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Fonts', 'all-business'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Colors', 'all-business'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Elements', 'all-business'), 
	...
	$wp_admin_bar->add_menu(array( 
		...
		'title' => esc_attr__('Single', 'all-business'), 
...
function all_business_show_msg($message, $msgclass = 'info') {
	echo '<div id="message" class="' . $msgclass . '">' . $message . '</div>';
}


function all_business_admin_msgs() {
	global $pagenow;
	...
	if ($pagenow == 'admin.php' && current_user_can('manage_options') && $cmsmasters_settings_pg !== false && !empty($set_errors)) {
		if ($set_errors[0]['code'] == 'settings_updated' && isset($_GET['settings-updated'])) {
			all_business_show_msg('<p><strong>' . $set_errors[0]['message'] . '</strong></p>', 'updated');
		} else {
			foreach ($set_errors as $set_error) {
				all_business_show_msg('<p class="setting-error-message" title="' . esc_attr($set_error['setting']) . '">' . $set_error['message'] . '</p>', 'error');
			}
		}
	}
}

add_action('admin_notices', 'all_business_admin_msgs');


function all_business_add_global_options() {
	$cmsmasters_option_names = array( 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_general', 
			all_business_options_general_fields('general') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_bg', 
			all_business_options_general_fields('bg') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_header', 
			all_business_options_general_fields('header') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_content', 
			all_business_options_general_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_footer', 
			all_business_options_general_fields('footer') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_content', 
			all_business_options_font_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_link', 
			all_business_options_font_fields('link') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_nav', 
			all_business_options_font_fields('nav') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_heading', 
			all_business_options_font_fields('heading') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_font_other', 
			all_business_options_font_fields('other') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_sidebar', 
			all_business_options_element_fields('sidebar') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_icon', 
			all_business_options_element_fields('icon') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_lightbox', 
			all_business_options_element_fields('lightbox') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_sitemap', 
			all_business_options_element_fields('sitemap') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_error', 
			all_business_options_element_fields('error') 
		), 
		array( 
			'cmsmasters_options_' . CMSMASTERS_SHORTNAME . '_element_code', 
			all_business_options_element_fields('code') 
		), 
		array( 
	...
	foreach (all_business_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, array( 
			...
			all_business_options_color_fields($key) 
		));
	}
...
function all_business_get_global_options() {
