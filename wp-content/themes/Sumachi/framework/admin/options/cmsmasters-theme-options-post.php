...
function get_custom_post_meta_fields() {
	...
	$tabs_array['cmsmasters_post'] = array( 
		'label' => esc_html__('Post', 'all-business'), 
	...
	$custom_post_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Don\'t Show Featured Image in Open Post', 'all-business'), 
			'desc'	=> esc_html__('Don\'t Show', 'all-business'), 
		...
		array( 
			'label'	=> esc_html__('Post Image', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Gallery', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Audio Links', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Color', 'all-business'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Post Title', 'all-business'), 
		...
		array( 
			'label'	=> esc_html__('Page Layout', 'all-business'), 
			'desc'	=> '', 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
			...
			'options' => array( 
				'r_sidebar' => array( 
					...
					'label' => esc_html__('Right Sidebar', 'all-business'), 
					'value'	=> 'r_sidebar' 
				), 
				'l_sidebar' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/sidebar_l.jpg', 
					'label' => esc_html__('Left Sidebar', 'all-business'), 
					'value'	=> 'l_sidebar' 
				), 
				'fullwidth' => array( 
					'img'	=> get_template_directory_uri() . '/framework/admin/inc/img/fullwidth.jpg', 
					'label' => esc_html__('Full Width', 'all-business'), 
					'value'	=> 'fullwidth' 
				) 
			) 
		), 
		array( 
			'label'	=> esc_html__('Choose Right\Left Sidebar', 'all-business'), 
			'desc'	=> '', 
